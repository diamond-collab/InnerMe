...
async def get_questions_by_quiz_id(
    ...
    return await quiz_questions_repo.get_questions_by_quiz_id(
        session=session,
        quiz_id=quiz_id,
    )
...
async def get_question_by_id(
    ...
    return await quiz_questions_repo.get_question_by_id(
        session=session,
...
async def get_question_by_id_and_order(
    ...
    return await quiz_questions_repo.get_question_by_id_and_order(
        session=session,
        quiz_id=quiz_id,
        order=order,
    )
